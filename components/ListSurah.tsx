  ...
  return (
    <>
      <div className="flex my-6 drop-shadow-custom">
        ...
        <input type="text" onChange={event => setQuery(event.target.value)} className="text-sm rounded-lg appearance-none focus:outline-none focus:shadow-outline pl-8 px-4 py-2 w-full" placeholder="Cari surat" />
      </div>
