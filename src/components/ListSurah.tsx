  ...
  return (
    <>
      <div className="relative flex my-6 drop-shadow-custom dark:drop-shadow-dark">
        ...
        <input type="text" onChange={event => setQuery(event.target.value)} className="text-sm text-black dark:text-white rounded-lg appearance-none focus:outline-hidden focus:shadow-outline pl-8 px-4 py-2 w-full bg-white dark:bg-[#3D3D3D]" placeholder="Cari surat" />
      </div>
